...
import { SQLEngineComponent } from './sql_engine.component';

import { By } from '@angular/platform-browser';

describe('SQLEngineComponent', () => {
  let component:SQLEngineComponent;
  let fixture: ComponentFixture<SQLEngineComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ SQLEngineComponent ],
      imports: [ FormsModule ] // Import FormsModule for ngModel binding
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(SQLEngineComponent);
