...
import { EXCELEngineComponent } from './excel_engine.component';

import { By } from '@angular/platform-browser';

describe('EXCELEngineComponent', () => {
  let component:EXCELEngineComponent;
  let fixture: ComponentFixture<EXCELEngineComponent>;

  beforeEach(async () => {
    await TestBed.configureTestingModule({
      declarations: [ EXCELEngineComponent ],
      imports: [ FormsModule ] // Import FormsModule for ngModel binding
    }).compileComponents();
  });

  beforeEach(() => {
    fixture = TestBed.createComponent(EXCELEngineComponent);
